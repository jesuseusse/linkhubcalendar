...
export default async function TenantCalendarPage({ searchParams }: { searchParams: Promise<{ username?: string }> }) {
  ...
  if (!username) {
    return <div className="min-h-screen bg-zinc-50 flex items-center justify-center"><p className="text-sm text-zinc-500">Not found</p></div>;
  }
  try {
    ...
    return <div className="min-h-screen bg-zinc-50 flex items-center justify-center"><p className="text-sm text-zinc-500">Calendar not available</p></div>;
  }
}
