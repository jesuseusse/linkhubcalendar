			...
			<div className='max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-14 items-center relative'>
				...
				<div>
					<span className='inline-block bg-accent/20 text-accent px-4 py-2 rounded-full text-sm font-medium'>
						Diseñado para terapeutas y profesionales de bienestar
					</span>

					<h1 className='mt-6 text-4xl md:text-6xl font-bold leading-tight'>
						Consigue más pacientes
						<span className='text-primary block'>
							con tu página profesional
						</span>
					</h1>

					<p className='mt-6 text-lg text-mutedForeground max-w-xl'>
						Crea tu tarjeta profesional online, recibe contactos y permite que
						tus pacientes agenden citas automáticamente. Todo listo en minutos.
					</p>
					...
					<div className='mt-8 flex items-center gap-6 text-sm text-mutedForeground'>
						...
						<div>+500 terapeutas activos</div>
					</div>
				</div>
				...
				<div className='relative flex justify-center'>
					...
					<Image
						...
						alt='Terapeuta usando su página profesional'
