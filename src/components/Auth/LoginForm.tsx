...
export function LoginForm({ onSubmit, loading, error, onSwitchToSignUp }: Props) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          required
          className="w-full px-3 py-2 text-sm border border-border focus:outline-none focus:border-foreground"
        />
      </div>
      <div>
        <label className="block text-xs font-medium text-muted-foreground mb-1">
        ...
        <div className="relative">
          <input
            ...
            required
            className="w-full px-3 py-2 text-sm border border-border focus:outline-none focus:border-foreground pr-10"
          />
          <button
            type="button"
